 ...
 * setRequestedFps to specify a frame rate that works well with
...
public class CustomCameraSource {
    ...
    public static class Builder {
        ...
        private CustomCameraSource mCameraSource = new CustomCameraSource();
         ...
         */
        public CustomCameraSource build() {
    ...
    public CustomCameraSource start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public CustomCameraSource start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
